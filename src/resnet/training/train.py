...
from resnet.config.config import get_config
from resnet.data.dataset import get_train_dataset, get_val_dataset
from resnet.models.resnet_model import create_model
...
def train_model(config=None, use_wandb=True):
    ...
    if use_wandb:
        ...
        wandb_run = init_wandb(wandb_config, run_name='resnet-training', model_type='resnet')
        if wandb_run:
            wandb.config.update({
